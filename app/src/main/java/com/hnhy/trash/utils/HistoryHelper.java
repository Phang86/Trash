...
public class HistoryHelper {
     ...
     * @param word 物品名称
     */
    public static void saveHistory(List<TrashResponse.ResultBean.ListBean> list, String word) {
        for (TrashResponse.ResultBean.ListBean bean : list) {
     ...
     * @param bean
     */
    private static void saveHistory(TrashResponse.ResultBean.ListBean bean) {
